   ...
   */
    ...
    */
         ...
         btnHighlight.addEventListener('click', function() {
            const filterText = txtHighlight.value.toLowerCase().trim();
            console.log('Filter text:', filterText);
        
            const boldText = document.querySelectorAll('.speech p b');
            console.log('Bold Text:', boldText);
        
            boldText.forEach(bold => {
                const text = bold.textContent.toLowerCase();
                console.log('Text to compare:', text);
                if (text.includes(filterText)) {
                    console.log('Including:', text);
                    bold.classList.add('highlight');
                } else {
                    console.log('Excluding:', text);
                    bold.classList.remove('highlight');
                }
            });
        });
