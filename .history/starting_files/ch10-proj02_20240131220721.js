    ...
    */
         ...
         filterButton.addEventListener('click', function() {
             ...
             speechParagraphs.forEach(paragraph => {
                 ...
                 paragraph.querySelectorAll('span.highlight').forEach(span => {
                 ...
                 if (filterText !== '') {
                     ...
                     while (index !== -1) {
                         // Create a span element to highlight the matching text
                         const span = document.createElement('span');
                         span.className = 'highlight';
                         span.textContent = paragraph.textContent.substring(index, index + filterText.length);
                         span.style.backgroundColor = 'yellow';
     
                         // Replace the matching text with the span element
                         paragraph.textContent = paragraph.textContent.substring(0, index) +
                             span.outerHTML +
                             paragraph.textContent.substring(index + filterText.length);
