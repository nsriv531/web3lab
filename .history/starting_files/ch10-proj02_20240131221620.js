            ...
            speechParagraphs.forEach(paragraph => {
                ...
                if (filterText !== '') {
                    ...
                    while (index !== -1) {
                        ...
                        range.setEnd(paragraph.firstChild, index + filterText.length);
                        ...
                        // Move the index to the end of the highlighted text
                        index = text.indexOf(filterText, index + filterText.length);
                    }
                }
            });
        });
