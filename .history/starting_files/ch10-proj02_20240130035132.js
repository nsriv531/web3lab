document.addEventListener("DOMContentLoaded", function() {	
   ...
   */
    ...
    */
        ...
        function playerFilter(selectedPlayer) {
            const speeches = document.querySelectorAll('.speech');
            
            speeches.forEach(speech => {
                const speaker = speech.querySelector('span').textContent;
                if (selectedPlayer === 'All Players' || selectedPlayer === speaker) {
                    speech.style.display = 'block'; // Show speech
                } else {
                    speech.style.display = 'none'; // Hide speech
                }
            });
        }
