   ...
   */
    ...
    */
         ...
         filterButton.addEventListener('click', function() {
            ...
            console.log('Speech paragraphs:', speechParagraphs);
            ...
            speechParagraphs.forEach(paragraph => {
                ...
                console.log('After clearing highlights:', paragraph.innerHTML);
                
                // Highlight matching text
                if (filterText !== '') {
                    const regex = new RegExp(`\\b${filterText}\\b`, 'gi'); // Word boundary regex for whole word matching
                    paragraph.innerHTML = paragraph.innerHTML.replace(regex, '<span class="highlight">$&</span>');
                    console.log('After highlighting:', paragraph.innerHTML);
                }
            });
        });
